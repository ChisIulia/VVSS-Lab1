...
public class IncrementalIntegration {
    ...
    public void testAddStudentAndAssignment() {
        int initialSizeStudent = studentXMLRepo.getSize();
        ...
        assertEquals(1, studentXMLRepo.getSize() - initialSizeStudent);

        int initialSizeTema = temaLabXMLRepo.getSize();
        ...
        assertEquals(1, temaLabXMLRepo.getSize() - initialSizeTema);
    }

    @Test
    public void testAddStudentAndAssignmentAndNote() {
        // add tema
